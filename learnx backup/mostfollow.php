...
?>
	...
	<?php
	$querry = mysqli_query($con,"SELECT * FROM questions ORDER BY following DESC, following DESC");
...
//<![CDATA[
  ...
  <textarea name="answer" placeholder="Post a Answer" cols="50">
	...
	<input type="submit" value="POST">
      ...
      <p class="date"><?php echo$row['username']." "?><img src="images/more.gif" alt="" /> <a href="#" onclick="toggle_visibility('foo');">Read more...</a> <img src="images/timeicon.gif" alt="" /> <?php echo$row['date_created']?></p>
