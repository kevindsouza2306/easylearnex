 ...
 <div class="menu">
  ...
  <div class="lside">
    <div class="topmenu"> &nbsp;<a href="index.php">Home</a> | <a href="mostfollow.php">Most Followed</a> |
	<?php  if($_SESSION['login'] == 'TRUE') {?>
	<a href="myques.php">My Question</a> | <a href="followed.php">Followed Question</a> | <a href="liked.php">Liked Answers</a> | 
	<?php }?>
	<a href="">FAQ</a> | 
	</div>
    <div class="header">
	...
	echo "<center><p style='color:red; font-size:30px'>".$message."</p></center>";
	?>
...
<input type="text" placeholder="Post a Question" style="height:50px; width:70%" cols="60" name="questions" />
	...
	echo "<center><p style='color:red; font-size:30px'>".$message1."</p></center>";
	?>
