  ...
  <div class="lside">
	...
	$result=mysqli_query($con,$querypr);
	 if($row = @mysqli_fetch_assoc($result))
		 {
?><form action="dbProcess.php?option=setting" method="post">
     	<table style="font-size:24px; height:40">
<tr style="height:40px"><td><b>First Name : </td><td> <input type="text" name="fn" value="<?php echo $row['first_name']?>"></td></tr>
<tr style="height:40px"><td ><b>Last Name : </td><td> <input type="text" name="ln" value="<?php echo $row['last_name']?>"></td></tr>
<tr style="height:40px"><td ><b>Occupation : </td><td > <input type="text" name="oc" value="<?php echo $row['address']?>"></td></tr>
<tr style="height:40px"><td><b>User Name : </td><td> <input type="text" name="un" value="<?php echo $row['email_id']?>"></td></tr>
<tr style="height:40px"><td><b>Password : </td><td> <input type="password" name="pw"value="<?php echo $row['password']?>"></td></tr>
<tr style="height:40px"><td><b>Re-Type Password : </td><td> <input type="password" name="rpw" value="<?php echo $row['password']?>"></td></tr>

	</table>

	<center><input type="submit" value="save" style="height:40px; width:70px; font-size:24px"></center>
</form>
    <?php
}
